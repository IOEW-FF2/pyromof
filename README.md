...
To install is, you must have Python installed (ideally Python3.12, but other versions do probably also work). You can then clone the github repository and install it with `pip install -e .`.
